#!/usr/bin/env bash
# One-step, full-modality Qwen3.5-397B-A17B VLM LoRA functional test.
...
export VLM_LOG_BASE="${VLM_LOG_BASE:-${SCRIPT_DIR}/test_log}"
...
exec bash "${SHARED_DIR}/run_vlm_lora_smoke.sh" "$@"
